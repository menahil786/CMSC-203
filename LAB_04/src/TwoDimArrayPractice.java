   ...
   */
   public void printArray( )
   {
	   for (int i = 0; i < intArray.length; i++) {
	        for (int j = 0; j < intArray[i].length; j++) {
	            System.out.print(intArray[i][j] + " ");
	            animate(i, j); // Animate each value
	        }
    ...
    // Write your code here:
	   if (row < 0 || row >= intArray.length) {
	    ...
	    for (int j = 0; j < intArray[row].length; j++) {
	        ...
	        animate(row, j); // Animate the changes
	    }
    ...
    // Write your code here:
	   if (column < 0 || column >= COLUMNS) {
	    ...
	    for (int i = 1; i < ROWS; i++) {
	        ...
	        animate(i, column, min); // Animate with intermediate results
	    }
	    return min;
   }
	   ...
	   int count = 0;
	    for (int i = 0; i < ROWS; i++) {
	        for (int j = 0; j < COLUMNS; j++) {
	            ...
	            animate(i, j, count); // Animate the count
	        }
	    }
	    return count;
   }
